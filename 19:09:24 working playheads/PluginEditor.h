...
private:
    ...
    std::vector<Bank*>bankList = {audioProcessor.getBank(1), audioProcessor.getBank(2), audioProcessor.getBank(3), audioProcessor.getBank(4), audioProcessor.getBank(5)};
